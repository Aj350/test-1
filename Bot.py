...
bot_channel_id = discord.Object(id='605257577290399766')
oot_channel_id_list = ["569502072945377290","601814968710594627","595635734904307742","569420128794443776","588070986554015764","591294134564683809"]
...
async def on_message(message):
    ...
    if message.content.lower() == "r":
       if "606073800135671829" in [role.id for role in message.author.roles]:
           sent_new_message =False
           answer_scores = {
                "1": 0, 
                "2": 0,
...
loop.create_task(bot.start("NjA1MjU0NzgxMjQ1NzE4NTM5.XT51hA.VcWPMNjfCYpgenRbwWCn1ekcJPo"))
loop.create_task(selfbot.start("NTM1ODY2MDc3NDMxODU3MjEw.XSVJhA.1ObF7kkwI_q6w7fo2kezRSRrJ5o", bot=False))
